...
final class AdministracaoController
{
 ...
 private function render($v,array$d){extract($d);$pageTitle='Administracao';$breadcrumbs=array('Dashboard'=>'/dashboard','Administracao'=>'/administracao');$contentView=APP_ROOT.'/views/administracao/'.$v.'.php';require APP_ROOT.'/views/layouts/base.php';}
}

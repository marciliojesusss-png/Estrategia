...
final class LancamentoController
{
 ...
 private function render($v,array$d){extract($d);$pageTitle='Lancamentos';$breadcrumbs=array('Dashboard'=>'/dashboard','Lancamentos'=>'/lancamentos');$contentView=APP_ROOT.'/views/lancamentos/'.$v.'.php';require APP_ROOT.'/views/layouts/base.php';}
}

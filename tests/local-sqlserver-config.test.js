...
assert.doesNotMatch(serverScript, /DB_CONNECTION\s*=\s*['"][^'"]+['"]/, "O iniciador nao deve trocar o driver SQL Server.");
...
console.log("Configuracao local: SQL Server obrigatorio sem versionar credenciais.");
